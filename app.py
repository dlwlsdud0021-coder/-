...
/* 지수 카드 */
.idx-row { display:grid; grid-template-columns:1fr 1fr; gap:8px; margin:12px 0 12px; }
...
.sec-title { font-size:14px; font-weight:600; margin:0 0 10px; padding-left:16px; display:flex; align-items:center; gap:6px; }
.sec-lbl { font-size:11px; font-weight:600; color:#8E8E93; margin-bottom:6px; padding-left:2px; }
/* 카드 */
.card { background:#fff; border-radius:16px; padding:14px 16px; border:0.5px solid #E5E5EA; margin:0 0 8px; }
/* 분석 아이템 */
...
/* 예측 카드 */
.forecast-card { background:#fff; border-radius:16px; padding:16px; border:0.5px solid #E5E5EA; margin:0 0 8px; }
...
.advice-box { background:#EEEDFE; border-radius:14px; padding:14px 16px; margin:0 0 8px; }
...
/* 뉴스 카드 */
.news-card { background:#fff; border-radius:16px; padding:14px 16px; border:0.5px solid #E5E5EA; margin:0 0 8px; }
...
/* 스캐너 종목 카드 */
.stk-card { background:#fff; border-radius:16px; padding:14px 16px; margin:0 0 8px; border:0.5px solid #E5E5EA; }
...
/* 스캐너 요약 */
.sum-row { display:grid; grid-template-columns:1fr 1fr 1fr; gap:8px; margin:12px 0; }
...
.warn-box { background:#FCEBEB; border-radius:14px; padding:14px 16px; margin:0 0 8px; }
...
/* 보유 카드 액션 버튼 */
/* stk-card 바로 아래 버튼 — 카드 하단 자연스럽게 이어지기 */
...
[data-testid="stVerticalBlockSeparatorBlock"]:has(.stk-card) + [data-testid="stVerticalBlockSeparatorBlock"] {
...
def render_holdings_detail():
    ...
    st.markdown(f"""<div style="background:#EEEDFE;border-radius:16px;padding:16px 18px;margin:0 0 12px;">
    ...
    if disclosures:
        ...
        st.markdown("""<div style="margin:0 0 8px;background:#F8F8FA;border-radius:12px;padding:14px 16px;text-align:center;">
