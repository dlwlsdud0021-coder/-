...
POSITIVE_KEYWORDS = [
    "급등", "상승", "호재", "흑자", "실적개선", "성장", "수주", "증가",
    "기대감", "매수", "돌파", "신고가", "외국인 매수", "기관 매수",
    "상향", "목표가 상향", "추천", "긍정", "개선", "회복",
    "강세", "반등", "청신호", "순매수", "호조", "수익", "이익",
    "성공", "승인", "계약", "수출", "투자", "확대", "성장세",
]

NEGATIVE_KEYWORDS = [
    "급락", "하락", "악재", "적자", "실적부진", "감소", "취소", "손실",
    "불안", "매도", "하회", "신저가", "외국인 매도", "기관 매도",
    "하향", "목표가 하향", "경고", "부정", "악화", "위기",
    "약세", "붕괴", "주의", "순매도", "부진", "우려", "침체",
